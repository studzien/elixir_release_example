...
```bash
git clone https://github.com/studzien/elixir_release_example
cd elixir_release_example
...
./deploy/bin/releases upgrade 0.2.0
...
./deploy/bin/releases upgrade 0.3.0

iex(releases@127.0.0.1)4> ReleaseVersion.get
"0.3.0"

./deploy/bin/releases downgrade 0.1.0
...
./deploy/bin/releases downgrade 0.2.0
